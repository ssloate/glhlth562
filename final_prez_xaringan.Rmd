...
Help the Office of State Budget and Management <br> understand **changes in demographics** <br> and **future income tax revenues**.
---
class: left
...
**Note**: We can only predict taxes owed (liability), not taxes paid (revenue)
